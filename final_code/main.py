...
df_combinations.to_csv('liver_final.csv')

# Read the GridSearchCV results from a CSV file
results_df = pd.read_csv('liver_final.csv', names = ["C","gamma","mean_test_score"])
...
# Define a dictionary to look up the accuracy values given C and gamma
acc_dict = {(C, gamma): acc for C, gamma, acc in zip(C, gamma, acc_values)}
